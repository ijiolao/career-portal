            ...
            <div class="max-w-xl mx-auto">
                ...
                <form method="post" action="{{ route('store') }}" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autocomplete="description"></textarea>
                    ...
                    <div>
                        ...
                        <textarea id="requirements" name="requirements" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autocomplete="requirements"></textarea>
                        <x-input-error :messages="$errors->updatePassword->get('requirements')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="location" :value="__('Job Location')" />
                        <x-text-input id="location" name="location" type="text" class="mt-1 block w-full" autocomplete="title" />
                        <x-input-error :messages="$errors->updatePassword->get('location')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="salary" :value="__('Salary')" />
                        <x-text-input id="salary" name="salary" type="text" class="mt-1 block w-full" autocomplete="title" />
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker type="text" name="deadline" class="pr-10 -mt-3 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" placeholder="   Select date">
                    </div>
